...
import com.example.a11699.all.shengsuo.activity.adapter.MyAdapter;
import com.example.a11699.all.shengsuo.activity.object.Shop_class;

import java.util.ArrayList;
import java.util.List;

public class Shensuo_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shensuo_2);
        myList2 = findViewById(R.id.my_list2);
        initData();
        initview_child();
    }
    ...
    private void initview_child() {
        ...
        myList2.setLayoutManager(linearLayoutManager);
